    ...
    <section className="py-24 md:py-32 bg-linear-to-b from-white via-gray-50/40 to-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center mb-32 lg:mb-40">
          ...
          <div className="max-w-xl">
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-8">
              ...
              sed diam eget risus varius blandit sit amet non magna. Integer
          ...
          <div className="relative mx-auto lg:mx-0 max-w-95 md:max-w-115 lg:max-w-none">
            {/* Visual - image instead of circle */}
            <div className="relative mx-auto lg:mx-0 max-w-95 md:max-w-115 lg:max-w-none">
              <div className="aspect-9/16 md:aspect-4/5 lg:aspect-4/5 rounded-3xl overflow-hidden border border-gray-200 shadow-2xl shadow-gray-200/50 bg-black relative">
                <Image
                  src="/images/business-people-meeting.png"
                  alt="Builder workflow preview"
                  fill
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          {/* Visual - team photo */}
          <div
            className="relative mx-auto lg:mx-0 order-2 lg:order-1 max-w-125 lg:max-w-none 
rounded-3xl bg-white p-5 shadow-2xl shadow-gray-300/30 border border-gray-100"
          ...
          <div className="max-w-xl order-1 lg:order-2">
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-8">
              ...
              dui. Vivamus sagittis lacus vel augue laoreet rutrum faucibus
              dolor auctor.
            </p>
